...
export default function Page() {
  ...
  async function handleLogin(e: React.FormEvent) {
    e.preventDefault();  // Prevent default form submission behavior from browser
    setError("");
    setSuccessMessage("");
    setLoading(true);
  ...
  return (
    <div className="w-full min-h-screen flex items-center justify-center bg-gray-100">
      <form
        ...
        className="relative flex flex-col items-center gap-4 bg-white p-8 rounded shadow-md sm:w-md"
      >
        <Link
          href="/"
          title="Back to homepage"
          aria-label="Back to homepage"
          className="absolute top-6 left-6 py-2 px-5 rounded-lg border border-gray-300 hover:scale-[1.02] transition-transform"
        >
